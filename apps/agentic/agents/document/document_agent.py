...
@tool_spec(
    ...
    metadata=ToolSpec(
        primary_function="""
            ...
            Use for loading research documents (Markdown), GitHub repositories, or PDF documents.
            Pass the full form data as the request string.
        """,
        positive_examples=[
...
<document_loading>
When the user wants to load a document, call delegate_to_document_loader_agent and pass
the full form data as the request string. Applies to:
