...
from apps.plots.bar_chart_plots import generate_bar_chart, generate_multi_bar_chart
...
class BarChartAgent(ReactAgent):
    ...
    def bar_chart_tool(data: Dict[str, float],
        ...
        bar_chart_file = generate_bar_chart(
            data=data, 
            title=title, 
            xlabel=x_axis_label, 
            ylabel=y_axis_label, 
    ...
    def multi_bar_chart_tool(categories: List[str],
        ...
        bar_chart_file = generate_multi_bar_chart(
